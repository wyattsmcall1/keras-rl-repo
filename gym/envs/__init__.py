...
register(
    id='Pendulum_pawl-v0',
    entry_point='gym.envs.classic_control:PendulumPawlEnv',
    max_episode_steps=200,
)

register(
    id='Pendulum_discrete-v0',
    entry_point='gym.envs.classic_control:PendulumDiscreteEnv',
    max_episode_steps=200,
)

register(
    id='Pendulum_human-v0',
    entry_point='gym.envs.classic_control:PendulumHumanEnv',
    max_episode_steps=200,
)
