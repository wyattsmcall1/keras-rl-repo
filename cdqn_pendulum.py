...
agent.load_weights('cdqn_{}_weights_separate.h5f'.format(ENV_NAME))
...
agent.save_weights('cdqn_{}_weights_separate.h5f'.format(ENV_NAME), overwrite=True)
